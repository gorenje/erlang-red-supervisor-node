module.exports = function(RED) {
  function CoreelxmoduleFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("elxmodule.label.statusset") });
  ...
  RED.nodes.registerType("elxmodule", CoreelxmoduleFunctionality);
