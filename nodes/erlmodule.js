module.exports = function(RED) {
  function CoreerlmoduleFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("erlmodule.label.statusset") });
  ...
  RED.nodes.registerType("erlmodule", CoreerlmoduleFunctionality);
