module.exports = function(RED) {
  function CoreerlgenserverFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("erlgenserver.label.statusset") });
  ...
  RED.nodes.registerType("erlgenserver", CoreerlgenserverFunctionality);
