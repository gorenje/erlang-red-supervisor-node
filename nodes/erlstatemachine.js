module.exports = function(RED) {
  function CoreerlstatemachineFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("erlstatemachine.label.statusset") });
  ...
  RED.nodes.registerType("erlstatemachine", CoreerlstatemachineFunctionality);
