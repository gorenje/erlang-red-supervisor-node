module.exports = function(RED) {
  function CoreerleventhandlerFunctionality(config) {
    ...
    node.on("input", function(msg, send, done) {
        ...
        node.status({ fill: "green", shape: "ring", text: RED._("erleventhandler.label.statusset") });
  ...
  RED.nodes.registerType("erleventhandler", CoreerleventhandlerFunctionality);
